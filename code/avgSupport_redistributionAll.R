...
dv_labels <- c(
  ...
  redis_reasons_rich_num = "Violating outcomes \n Rich",               
  redis_reasons_poor_num = "Violating outcomes \n Poor",                 
  redis_effort_num = "Fairness of the income distribution",                  
  redis_social_benefits_num = "Social benefits \n not a choice",            
  redis_welfare_num = "Welfare goes to \n the underserving",             
