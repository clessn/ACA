...
# Labels for plotting
dv_labels <- c(
  budget_health_priority_num = "Health", 
  budget_education_priority_num = "Education",
  budget_pensions_priority_num = "Pensions",
  budget_taxes_priority_num = "Taxes",
  budget_debt_priority_num = "Debt"
)
...
ggsave(
  filename = "graphs/avgSupport_budgetPriorities.png",
  plot     = plot,
  width    = 10,
  height   = 8,
  dpi      = 300
