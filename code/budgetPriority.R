...
dv_labels <- c(
  budget_health_priority_bin = "Health", 
  budget_education_priority_bin = "Education",
  budget_pensions_priority_bin = "Pensions",
  budget_taxes_priority_bin = "Taxes",
  budget_debt_priority_bin = "Debt"
)
...
modelsummary(
  ...
  coef_map = var_labels,
  output   = "html",
  file     = "modelsummary/budgetPriority.html"
)
...
ggsave(
  filename = "graphs/logOdds_budgetPriorities.png",
  plot     = coef_plot,
  width    = 10,
  height   = 8,
  dpi      = 300
