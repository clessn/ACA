...
dv_labels <- c(
  budget_spend_prio_health_bin = "Health", 
  budget_spend_prio_seniors_bin = "Seniors",
  budget_spend_prio_childcare_bin = "Child care",
  budget_spend_prio_costLiving_bin = "Cost of Living",
  budget_spend_prio_climateChange_bin = "Climate Change"
)
...
modelsummary(
  ...
  coef_map = var_labels,
  output   = "html",
  file     = "modelsummary/spendingPriority.html"
)
...
ggsave(
  filename = "graphs/logOdds_spendingPriorities.png",
  plot     = coef_plot,
  width    = 10,
  height   = 8,
  dpi      = 300
